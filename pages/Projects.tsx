        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {projects.map((project, idx) => (
            <motion.div
              ...
              id={`btn-project-video-${project.title.toLowerCase().replace(/\s+/g, '-')}`}
        ...
        {selectedVideo && (
          ...
          >
            ...
            <motion.div
              ...
              className="w-full max-w-6xl aspect-video bg-black rounded-[3rem] overflow-hidden shadow-premium border-2 border-white/10 relative"
              style={{
                backgroundImage: `url(${projects.find(p => p.videoId === selectedVideo)?.img})`,
