            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20 relative z-20">
                        ...
                        >
                            ...
                            <div className="relative bg-white p-12 rounded-[2.5rem] shadow-premium border border-slate-100 flex flex-col md:flex-row gap-8 items-center h-full">
                                ...
                                <div className="flex-grow text-center md:text-left">
                                    ...
                                    <a 
                                        href={item.link} 
                                        id={`btn-download-resource-${item.title.toLowerCase().replace(/\s+/g, '-')}`}
                                        download 
                                        target="_blank" 
                                        rel="noopener noreferrer"
                                        className={`w-full md:w-auto px-8 py-4 bg-gray-900 group-hover:bg-vibrant-orange text-white rounded-2xl flex items-center justify-center gap-4 text-xs font-black uppercase tracking-widest transition-all shadow-xl group-hover:shadow-vibrant-orange`}
                                    >
                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        ...
                        <button 
                            id="btn-downloads-technical-support"
                            className="px-12 py-6 bg-vibrant-orange text-white font-black uppercase text-sm tracking-widest rounded-2xl hover:bg-orange-500 transition-all transform hover:scale-105 shadow-vibrant-orange"
                        >
