          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="order-2 lg:order-1 space-y-10">
              ...
              <div className="space-y-8 text-xl text-gray-500 font-medium leading-relaxed">
                <p>
                  <strong className="text-gray-900 font-black">A Krenke Brinquedos Pedagógicos LTDA</strong> não apenas fabrica equipamentos; nós definimos o padrão nacional de excelência em diversão desde 1987.
                </p>
