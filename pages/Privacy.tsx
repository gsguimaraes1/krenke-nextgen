            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/60 p-8 md:p-12 border border-slate-100">
                    ...
                    <PolicySection title="1. Coleta de Informações" icon={Eye}>
                        <p>
                            A Krenke Brinquedos Pedagógicos LTDA coleta informações para fornecer melhores serviços a todos os nossos usuários. Coletamos informações das seguintes formas:
                        </p>
                    ...
                    <PolicySection title="4. Compartilhamento de Informações" icon={Scale}>
                        <p>
                            Não compartilhamos informações pessoais com empresas, organizações ou indivíduos externos à Krenke Brinquedos Pedagógicos LTDA, exceto nas seguintes circunstâncias:
                        </p>
                        <ul className="list-disc pl-5 space-y-2">
