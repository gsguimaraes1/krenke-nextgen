              ...
              {filteredProducts.map((product, idx) => (
                ...
                >
                  <div className="bg-white rounded-[2rem] overflow-hidden shadow-premium border border-slate-100 cursor-pointer flex flex-col transform transition-all duration-500 hover:-translate-y-4 h-full">
                    <div className="relative aspect-square p-6 bg-slate-50 flex items-center justify-center overflow-hidden">
                      <img
                        src={product.image}
                        alt={product.name}
                        className="w-full h-full object-contain transition-transform duration-700 group-hover:scale-[1.12] drop-shadow-2xl"
                      />
                    </div>

                    <div className="p-8 flex flex-col items-center text-center flex-grow">
                      <h3 className="text-xl font-black text-gray-900 uppercase tracking-tighter mb-4 group-hover:text-vibrant-orange transition-all min-h-[3.5rem] flex items-center justify-center line-clamp-2">
                        {product.name}
                      </h3>
