...
// Horário comercial: Seg-Sex 07:30-12:00 e 13:00-17:30. Fora disso = offline.
export function useBusinessHours() {
  ...
  useEffect(() => {
    const check = () => {
      ...
      if (day === 0 || day === 6) { setIsOffline(true); return; }
...
// Painel branco com o formulário do WhatsApp. A abertura/fechamento é
// controlada pelo componente pai (WhatsAppWidget ou ContactLauncher).
export const WhatsAppForm: React.FC<WhatsAppFormProps> = ({ open, onClose }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Salva via endpoint (fire-and-forget) — Turnstile, insert e dispatch em /api/submit-lead.
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                <option value="" disabled>
                  {loadingCities ? 'Carregando...' : 'Cidade *'}
                </option>
                {cities.map(c => (
